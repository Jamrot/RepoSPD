...
![dropout](./Figures/Algorithm1.png)
...
#### Reviewer(C) Q1: Training and inference time.
...
<center>Table. 3 Time cost between RepoSPD and CodeT5 per epoch training and inference time. </center>
...
<center>Table. [] Experimental results of AUC and statistical analysis</center>



#### Dataset / Results available
